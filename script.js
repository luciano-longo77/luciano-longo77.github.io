...
window.openModal = function(modalId) {
    ...
    trapFocus(modal);
    setTimeout(() => {
        const closeBtn = modal.querySelector('[aria-label^="Chiudi"]') || modal.querySelector('button');
        closeBtn?.focus();
    }, 50);
};
...
window.tailwind.config = {
    theme: {
        extend: {
            ...
            colors: { brand: { 50: '#f8fafc', 800: '#1e293b', 900: '#0f172a' }, gold: '#947a4b', goldLight: '#bfa577', goldDark: '#7a633d' },
